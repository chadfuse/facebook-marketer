const { getAuthenticatedContext, humanType, humanSimulateBrowsing, setupLowMemoryRouteBlocking, withBrowserLock } = require('./fb-browser');
...
/**
 * Executes posting a single message to a target Facebook group (Single-instance low RAM)
 */
